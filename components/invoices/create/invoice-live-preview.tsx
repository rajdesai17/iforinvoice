  ...
  return (
    ...
    >
      <div className="h-full flex flex-col p-6 overflow-hidden">
        ...
        <div className="flex-shrink-0 flex gap-8 text-xs mb-5">
          <div>
        ...
        <div className="flex-shrink-0 grid grid-cols-2 gap-4 mb-5">
          {/* Billed By Card */}
          <div className="bg-gray-50/80 rounded-lg p-4 border border-gray-100">
            <h3 className="text-primary font-medium text-xs mb-1.5">Billed By</h3>
            <p className="font-semibold text-gray-900 text-sm">{displayCompanyName}</p>
            {displayCompanyAddress && (
              <p className="text-gray-500 text-xs mt-1 leading-relaxed">{displayCompanyAddress}</p>
            )}
          </div>

          {/* Billed To Card */}
          <div className="bg-gray-50/80 rounded-lg p-4 border border-gray-100">
            <h3 className="text-primary font-medium text-xs mb-1.5">Billed To</h3>
            {client ? (
              <>
              ...
              <p className="text-gray-400 text-sm">Select a client</p>
            )}
          </div>
        </div>
